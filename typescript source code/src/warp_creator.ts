...
MCFunction("warp/create/confirm", () => {
	...
	execute
		.as(Selector("@e", { type: "minecraft:armor_stand", sort: "nearest", limit: 1 }))
		.at(Selector("@s"))
		.run.tp(abs(0, -64, 0));
	execute
		.as(Selector("@e", { type: "minecraft:armor_stand", sort: "nearest", limit: 1 }))
