...
class BasePathClass {
    constructor(datapack, basePath) {
        ...
        this.MCFunction = (name, callback, options) => {
            ...
            const mcfunction = new _resources_1.MCFunctionClass(this.datapack, this.getName(name), callback, {
                onConflict: (_a = this.onConflict) === null || _a === void 0 ? void 0 : _a.mcFunction, ...options,
            });
        ...
        this.ItemModifier = (name, modifier, options) => {
            var _a;
            return (new _resources_1.ItemModifierInstance(this.datapack, this.getName(name), modifier, { onConflict: (_a = this.onConflict) === null || _a === void 0 ? void 0 : _a.predicate, ...options }));
        };
        ...
        if (onConflict === null || onConflict === void 0 ? void 0 : onConflict.default) {
            ...
            (_g = onConflict.itemModifier) !== null && _g !== void 0 ? _g : (onConflict.itemModifier = onConflict.default);
        }
    ...
    getName(name) {
        ...
        if (!namespace.match(/^[0-9a-z_\-.]+$/)) {
            throw new Error(`A namespace should only contain numbers, lowercase letters, underscores, hyphen/minus and dot/period, and be at least 1 caracter long: got "${namespace}"`);
        }
        /**
         * For resources:
