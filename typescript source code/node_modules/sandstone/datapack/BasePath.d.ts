import { AdvancementInstance, ItemModifierInstance, LootTableInstance, PredicateInstance, RecipeInstance, TagInstance } from "../resources";
import type { HideFunctionProperties } from "../generalTypes";
import type { AdvancementJSON, HintedTagStringType, ItemModifierJSON, LootTableJSON, PredicateJSON, RecipeJSON, TAG_TYPES, TagSingleValue } from "../arguments";
import type { Datapack } from "./";
import type { AdvancementOptions, ItemModifierOptions, LootTableOptions, MCFunctionOptions, PredicateOptions, RecipeOptions, TagOptions } from "../resources";
...
export declare class BasePathClass<N extends (undefined | string) = (undefined | string), D extends (undefined | string) = (undefined | string)> {
    ...
    onConflict: {
        ...
        itemModifier?: import("../generalTypes").BASIC_CONFLICT_STRATEGIES | undefined;
    } | undefined;
     ...
     */
    MCFunction: <RETURN extends void | Promise<void>, _ extends RETURN = RETURN>(name: string, callback: (this: MCFunctionInstance<_>) => RETURN, options?: MCFunctionOptions | undefined) => MCFunctionInstance<RETURN>;
    /**
     * Create a predicate.
     *
    ...
    ItemModifier: (name: string, modifier: ItemModifierJSON, options?: ItemModifierOptions | undefined) => ItemModifierInstance;
}
