import type { AdvancementJSON, ItemModifierJSON, LootTableJSON, PredicateJSON, RecipeJSON, TAG_TYPES, TagSingleValue } from "../arguments";
...
declare type AdvancementProperties = {
    advancement: AdvancementJSON<string>;
};
...
declare type RecipeProperties = {
    recipe: RecipeJSON<string, string, string>;
};
export declare type RecipeResource = FolderOrFile<RecipeProperties>;
declare type ItemModifierProperties = {
    modifier: ItemModifierJSON;
};
export declare type ItemModifierResource = FolderOrFile<ItemModifierProperties>;
/**
...
export declare type ResourceConflictStrategy<T extends ResourceTypes, U extends ResourceOnlyTypeMap[T] = ResourceOnlyTypeMap[T]> = ('throw' | 'replace' | 'ignore' | 'warn' | ((oldResource: U, newResource: U) => U));
export declare class ResourcesTree {
     ...
     */
    addResource<T extends ResourceTypes, U extends ResourceTypeMap[T] = ResourceTypeMap[T]>(resourceType: T, resource: U, conflictStrategy: ResourceConflictStrategy<T>): U & ResourceTypeMap[T];
    /**
