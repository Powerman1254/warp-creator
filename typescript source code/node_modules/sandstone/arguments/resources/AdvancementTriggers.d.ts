...
import type { BlockIdCriterion, DamageCriterion, DimensionCriterion, DistanceCriterion, EffectCriterion, EntityCriterion, ItemCriterion, LocationCriterion, NumberProvider, PotionIdCriterion, SlotCriterion } from './criteria';
import type { PredicateJSON } from './predicate';
declare type Trigger<NAME extends string, CONDITIONS extends Record<string, unknown> | undefined> = {
    /**
