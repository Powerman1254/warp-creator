...
import type { JSONTextComponent, LootTableEntry } from "..";
import type { BASIC_COLORS, MAP_ICONS } from "../basics";
import type { ATTRIBUTES, BLOCKS, ENCHANTMENTS, STRUCTURES } from "../generated";
...
declare type ItemModifierKind<TYPE extends string, VALUES extends Record<string, unknown>> = {
    /**
...
export declare type ItemModifierFunction = {
...
}> | ItemModifierKind<'explosion_decay', {}> | ItemModifierKind<'furnace_smelt', {}> | ItemModifierKind<'fill_player_head', {
    /**
    ...
    enchantments: {
        [K in ENCHANTMENTS]?: NumberProvider;
    };
    add?: boolean;
...
export declare type ItemModifierJSON = ObjectOrArray<ItemModifierFunction>;
export {};
