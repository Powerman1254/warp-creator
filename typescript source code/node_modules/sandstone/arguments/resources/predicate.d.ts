...
import type { BLOCKS, ENCHANTMENTS } from "..";
import type { DamageCriterion, EntityCriterion, ItemCriterion, LocationCriterion, NumberProvider } from './criteria';
 ...
 * ]
 */
export declare type PredicateJSON = ObjectOrArray<PredicateCondition>;
export {};
