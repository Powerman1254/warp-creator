...
import type { Coordinates, JSONTextComponent, NBTObject, SingleEntityArgument } from "../arguments";
import type { DataModifyType, DataModifyValues, StoreType } from "../commands/implementations";
...
export declare class DataInstance<TYPE extends DATA_TYPES = DATA_TYPES> {
    ...
    toString: () => DATA_TARGET[TYPE];
    toJSON: () => DATA_TARGET[TYPE];
}
export declare class DataPointInstance<TYPE extends DATA_TYPES = DATA_TYPES> extends ConditionTextComponentClass {
    ...
    protected executeStore: (storeType: StoreType, scale: number) => import("../commands/implementations").ExecuteWithRun<import("../commands").CommandsRoot>;
    set: (
    /**
