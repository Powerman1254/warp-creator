...
import type { ENTITY_TYPES, GAMEMODES, Range, RootNBT, TextComponentObject } from "../arguments";
...
export declare class SelectorClass<IsSingle extends boolean = false, IsPlayer extends boolean = false> extends ComponentClass implements ConditionClass {
    protected commandsRoot: CommandsRoot;
    target: "@s" | "@p" | "@a" | "@e" | "@r";
    arguments: SelectorProperties<IsSingle, IsPlayer>;
    constructor(commandsRoot: CommandsRoot, target: '@s' | '@p' | '@a' | '@e' | '@r', selectorArguments?: SelectorProperties<IsSingle, IsPlayer>);
    /**
...
export declare type SelectorCreator = (((target: '@s' | '@p' | '@r', selectorArguments?: Omit<AnySelectorProperties, 'limit' | 'type'>) => SelectorClass<true, true>) & ((target: '@a', selectorArguments: Omit<SingleSelectorProperties, 'type'>) => SelectorClass<true, true>) & ((target: '@a', selectorArguments?: Omit<AnySelectorProperties, 'type'>) => SelectorClass<false, true>) & ((target: '@e', selectorArguments: SinglePlayerSelectorProperties) => SelectorClass<true, true>) & ((target: '@e', selectorArguments: SingleSelectorProperties) => SelectorClass<true, false>) & ((target: '@e', selectorArguments?: AnySelectorProperties) => SelectorClass<false, false>));
export {};
