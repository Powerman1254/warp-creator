...
import type { JSONTextComponent, MultipleEntitiesArgument, ObjectiveArgument, Range } from "../arguments";
import type { CommandsRoot } from "../commands";
import type { ConditionClass } from "./";
...
export declare class Score<OBJ_CRITERION extends string | undefined = string | undefined> extends ComponentClass implements ConditionClass {
    ...
    toString(): string;
    toJSON(): {
        readonly type: "minecraft:score";
        readonly target: {
            readonly type: "minecraft:fixed";
    ...
    _toMinecraftCondition: () => {
        value: (number | MultipleEntitiesArgument)[];
    };
    ...
    '=': {
        (targets: PlayersTarget, objective?: ObjectiveArgument | undefined): this;
        (amountOrTargetScore: number | Score): this;
        (nbt: DataPointInstance, scale?: number | undefined): this;
    };
    /**
    ...
    '+=': {
        (targets: MultipleEntitiesArgument, objective?: ObjectiveArgument | undefined): this;
        (amountOrTargetScore: number | Score): this;
    };
    /**
    ...
    '><': {
        (targets: MultipleEntitiesArgument, objective?: ObjectiveArgument | undefined): void;
        (targetScore: Score): void;
    };
    ...
    '+': {
        (targets: MultipleEntitiesArgument, objective?: ObjectiveArgument | undefined): Score;
        (amountOrTargetScore: number | Score): Score;
    };
    /**
    ...
    '>': {
        (targets: MultipleEntitiesArgument, objective?: ObjectiveArgument | undefined): ConditionClass;
        (amountOrTargetScore: number | Score): ConditionClass;
    };
    /**
    ...
    matches: (range: Range) => {
        _toMinecraftCondition: () => {
            value: (MultipleEntitiesArgument | ObjectiveClass<OBJ_CRITERION>)[];
        };
    };
}
export {};
