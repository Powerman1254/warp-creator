...
export declare class CloneOptions extends Command {
     ...
     */
    replace: (mode?: "force" | "move" | "normal" | undefined) => void;
    /**
     ...
     * - `normal`: Don't move or force.
     */
    masked: (mode?: "force" | "move" | "normal" | undefined) => void;
    /**
     ...
     * - `normal`: Don't move or force.
     */
    filtered: (filter: LiteralUnion<BLOCKS>, mode?: "force" | "move" | "normal" | undefined) => void;
}
