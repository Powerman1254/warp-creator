...
declare class AdvancementArguments extends Command {
     ...
     */
    only: (advancement: string | AdvancementInstance, criterion?: string | undefined) => void;
    /**
     ...
     * @param advancement Specifies a valid namespaced id of the advancement to target.
     */
    from: (advancement: string | AdvancementInstance) => void;
    /**
     ...
     * @param advancement Specifies a valid namespaced id of the advancement to target.
     */
    through: (advancement: string | AdvancementInstance) => void;
    /**
     ...
     * @param advancement Specifies a valid namespaced id of the advancement to target.
     */
    until: (advancement: string | AdvancementInstance) => void;
}
