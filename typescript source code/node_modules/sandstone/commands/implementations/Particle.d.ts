...
import type { BLOCKS, Coordinates, ITEMS, MultiplePlayersArgument, PARTICLE_TYPES } from "../../arguments";
 ...
 * @param viewers Allows control of which player should view this particle instead of everyone in the viewing range of the particle.
 */
(name: 'minecraft:dust', colors: [red: number, green: number, blue: number, size: number], size: number, pos?: Coordinates, delta?: [deltaX: number, deltaY: number, deltaZ: number], speed?: number, count?: number, mode?: 'force' | 'normal', viewers?: MultiplePlayersArgument) => void) & (
/**
