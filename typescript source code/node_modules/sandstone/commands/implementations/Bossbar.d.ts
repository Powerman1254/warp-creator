...
export declare class Bossbar extends Command {
     ...
     */
    set: (id: string) => BossbarSet;
}
declare class BossbarSet extends Command {
    /**
     ...
     */
    color: (color: LiteralUnion<BASIC_COLORS>) => void;
    /**
     ...
     */
    players: (players?: MultiplePlayersArgument | undefined) => void;
    /**
     ...
     */
    style: (style: 'progress' | 'notched_6' | 'notched_10' | 'notched_12' | 'notched_20') => void;
    /**
