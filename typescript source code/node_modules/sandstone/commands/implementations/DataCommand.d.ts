...
export declare class DataGet extends Command {
    /**
...
export declare class DataMerge extends Command {
    /**
     ...
     */
    block: (targetPos: Coordinates, nbt: NBTObject) => void;
    /**
     ...
     * @param nbt The NBT to merge with.
     */
    entity: (target: SingleEntityArgument, nbt: NBTObject) => void;
    /**
     ...
     * @param nbt The NBT to merge with.
     */
    storage: (target: string, nbt: NBTObject) => void;
}
export declare class DataModifyValues extends Command {
    private fromBlock;
    private fromEntity;
    private fromStorage;
    from: {
...
export declare class DataModifyType extends Command {
...
export declare class DataModify extends Command {
    /**
...
export declare class DataRemove extends Command {
    /**
