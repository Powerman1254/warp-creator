import { AdvancementCommand, Bossbar, DataCommand, DatapackCommand, Debug, Effect, ExecuteWithRun, Experience, Forceload, Item, Loot, RecipeCommand, Schedule, Scoreboard, Team, Time, Weather, WorldBorder } from './implementations';
import type { LiteralUnion } from "../generalTypes";
import type { BIOMES, BLOCKS, Coordinates, ENTITY_TYPES, GAMEMODES, GAMERULES, ITEMS, JSONTextComponent, MessageOrSelector, MultipleEntitiesArgument, MultiplePlayersArgument, RootNBT, Rotation, SingleEntityArgument, SinglePlayerArgument, SOUND_EVENTS, SOUND_SOURCES, STRUCTURES } from "../arguments";
...
export declare class CommandsRoot {
    ...
    attribute: (target: SingleEntityArgument, attribute: string) => import("./implementations").AttributeOperation;
    bossbar: Bossbar;
    /**
     ...
     */
    clear: (targets?: MultiplePlayersArgument | undefined, item?: LiteralUnion<ITEMS> | TagInstance<"items"> | undefined, maxCount?: number | undefined) => void;
    clone: (begin: Coordinates, end: Coordinates, destination: Coordinates) => import("./implementations").CloneOptions;
    /**
    ...
    difficulty: (difficulty?: import("../arguments").DIFFICULTIES | undefined) => void;
    effect: Effect;
    enchant: (targets: MultipleEntitiesArgument, enchantment: LiteralUnion<import("../arguments").ENCHANTMENTS>, level?: number | undefined) => void;
    get execute(): Omit<ExecuteWithRun<CommandsRoot>, 'run' | 'runOne'>;
    xp: Experience;
    fill: (from: Coordinates, to: Coordinates, block: LiteralUnion<BLOCKS>) => import("./implementations").FillArguments;
    forceload: Forceload;
    functionCmd: (functionName: string | TagInstance<"functions">) => void;
    /**
     ...
     */
    help: (command_?: LiteralUnion<"list" | "advancement" | "recipe" | "schedule" | "team" | "tag" | "gamemode" | "execute" | "attribute" | "bossbar" | "clone" | "data" | "datapack" | "debug" | "defaultgamemode" | "difficulty" | "effect" | "give" | "clear" | "enchant" | "scoreboard" | "comment" | "experience" | "fill" | "functionCmd" | "forceload" | "gamerule" | "help" | "kill" | "locate" | "locatebiome" | "loot" | "me" | "msg" | "particle" | "playsound" | "raw" | "reload" | "item" | "say" | "seed" | "setblock" | "setidletimeout" | "setworldspawn" | "spawnpoint" | "spectate" | "spreadplayers" | "stopsound" | "summon" | "teammsg" | "teleport" | "tellraw" | "time" | "title" | "trigger" | "w" | "weather" | "worldborder" | "tm" | "tp" | "xp" | "tell"> | undefined, ...parameters: string[]) => void;
    /**
    ...
    tag: (targets: MultipleEntitiesArgument) => import("./implementations").TagArguments;
    team: Team;
    /**
    ...
    tp: ((destinationEntity: SingleEntityArgument) => void) & ((location: Coordinates) => void) & ((targets: MultipleEntitiesArgument, destinationEntity: SingleEntityArgument) => void) & ((targets: MultipleEntitiesArgument, location: Coordinates) => import("./implementations").TeleportFacing) & ((targets: MultipleEntitiesArgument, location: Coordinates, rotation: Rotation) => void);
    /**
    ...
    time: Time;
    title: (targets: MultiplePlayersArgument) => import("./implementations").TitleArguments;
    trigger: (objective: import("../arguments").ObjectiveArgument) => import("./implementations").TriggerArguments;
    weather: Weather;
