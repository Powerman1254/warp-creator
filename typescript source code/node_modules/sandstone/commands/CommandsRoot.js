...
const parsers_1 = require("../variables/parsers");
const decorators_1 = require("./decorators");
const implementations_1 = require("./implementations");
const Datapack_1 = __importDefault(require("../datapack/Datapack"));
class CommandsRoot {
    constructor(datapack) {
        ...
        /** COMMANDS */
        // advancement command //
        this.advancement = new implementations_1.AdvancementCommand(this);
        // attribute command //
        ...
        // data command //
        this.data = new implementations_1.DataCommand(this);
        // datapack command //
        ...
        this.xp = new implementations_1.Experience(this);
        // fill command //
        this.fill = (new implementations_1.Fill(this)).fill;
        // forceload command //
        this.forceload = new implementations_1.Forceload(this);
        // function command //
        this.functionCmd = (new implementations_1.FunctionCommand(this).function);
        /**
        ...
        // gamerule command //
        this.gamerule = (new implementations_1.GameruleCommand(this)).gamerule;
        /**
        ...
        // recipe command //
        this.recipe = new implementations_1.RecipeCommand(this);
        // reload command //
        /**
        ...
        this.raw = (...args) => { };
        // item command //
        this.item = new implementations_1.Item(this);
        // say command //
        /**
        ...
        // schedule command //
        this.schedule = new implementations_1.Schedule(this);
        // scoreboard command //
        ...
        this.spreadplayers = (new implementations_1.SpreadPlayers(this)).spreadplayers;
        /**
         * Stops a given sound.
         *
        ...
        // tag command //
        this.tag = (new implementations_1.TagCommand(this)).tag;
        // team command //
        this.team = new implementations_1.Team(this);
        ...
        this.tp = (new implementations_1.Teleport(this)).tp;
         ...
         * which is formatted as "name1 and name2" for two entities, or "name1, name2, ... and namen" for n entities.
         */
        this.w = (targets, ...messages) => { };
        // tellraw command //
        this.tellraw = (targets, message) => { };
        // time command //
        this.time = new implementations_1.Time(this);
        // title command //
        this.title = (new implementations_1.Title(this)).title;
        // trigger command //
        this.trigger = (new implementations_1.Trigger(this)).trigger;
        this.weather = new implementations_1.Weather(this);
        this.worldborder = new implementations_1.WorldBorder(this);
        // / ALIAS COMMANDS. ///
        /*
        ...
        this.tell = this.w;
        // teammsg command //
        this.teammsg = this.tm;
        // teleport command //
        this.teleport = this.tp;
        // msg command //
        this.msg = this.w;
        // experience command //
        this.experience = this.xp;
        this.arguments = [];
    ...
    // execute command //
    get execute() {
        const realExecute = new implementations_1.ExecuteWithRun(this);
...
__decorate([
    decorators_1.command('say', { isRoot: true, parsers: (args) => [args.join(' ')] }),
    __metadata("design:type", Object)
...
__decorate([
    decorators_1.command('setblock', { isRoot: true, parsers: { '0': parsers_1.coordinatesParser } }),
    __metadata("design:type", Object)
...
__decorate([
    decorators_1.command('setworldspawn', { isRoot: true, parsers: { '0': parsers_1.coordinatesParser, '1': parsers_1.rotationParser } }),
    __metadata("design:type", Object)
], CommandsRoot.prototype, "setworldspawn", void 0);
__decorate([
    decorators_1.command('spawnpoint', { isRoot: true, parsers: { '1': parsers_1.coordinatesParser, '2': parsers_1.rotationParser } }),
    __metadata("design:type", Object)
...
__decorate([
    decorators_1.command('summon', { isRoot: true, parsers: { '1': parsers_1.coordinatesParser, '2': _variables_1.nbtParser } }),
    __metadata("design:type", Object)
], CommandsRoot.prototype, "summon", void 0);
__decorate([
    decorators_1.command('tm', { isRoot: true }),
    __metadata("design:type", Object)
], CommandsRoot.prototype, "tm", void 0);
__decorate([
    decorators_1.command('w', { isRoot: true }),
    __metadata("design:type", Object)
], CommandsRoot.prototype, "w", void 0);
__decorate([
