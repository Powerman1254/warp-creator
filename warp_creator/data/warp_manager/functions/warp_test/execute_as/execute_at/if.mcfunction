...
execute store result entity @e[tag=warp, type=minecraft:marker, sort=nearest, limit=1] Rotation[0] double 0.01 run scoreboard players get @s pos3_rx
execute store result entity @e[tag=warp, type=minecraft:marker, sort=nearest, limit=1] Rotation[1] double 0.01 run scoreboard players get @s pos3_ry
